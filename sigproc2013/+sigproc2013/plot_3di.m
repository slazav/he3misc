...
% slazav, feb 2012
    ...
    logscale  = sigproc2013.par_get('log',    pars, 0 );
    sqrtscale = sigproc2013.par_get('sqrt',   pars, 1 );
    cutamp    = sigproc2013.par_get('cutamp', pars, -1 );
    colors    = sigproc2013.par_get('colors', pars, 'KRYW' );
    cbar      = sigproc2013.par_get('cbar',   pars, 5 );
    swapxy    = sigproc2013.par_get('swapxy', pars, 0 );
    flarm     = sigproc2013.par_get('flarm',  pars, 0 );
